...
public class SecurityConfig  {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOrigin("http://localhost:4200");  // Permite o Angular acessar a API
        ...
        configuration.setAllowCredentials(true);  // Permite credenciais (como cookies, headers, etc.)
